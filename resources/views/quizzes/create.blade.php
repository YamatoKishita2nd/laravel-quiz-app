    ...
    <form method="POST" action="{{ route('quizzes.index') }}">
        ...
        <div class="mt-3 mb-5">
            ...
            <div class="mt-1 ">
                ...
                <div class="input-group flex-nowrap my-2">
                    ...
                    <input name="answer_a" type="text" value="{{ old('answer_a') }}"
                        class="form-control @error('answer_a') is-invalid @enderror" placeholder="Aの答えを入力" aria-label="回答A"
                        aria-describedby="answer-a">
                </div>
                <div class="input-group flex-nowrap my-2">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="answer-b">B</span>
                    </div>
                    <input name="answer_b" type="text" value="{{ old('answer_b') }}"
                        class="form-control @error('answer_b') is-invalid @enderror" placeholder="Bの答えを入力" aria-label="回答B"
                        aria-describedby="answer-b">
                </div>
                <div class="input-group flex-nowrap my-2">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="answer-c">C</span>
                    </div>
                    <input name="answer_c" type="text" value="{{ old('answer_c') }}"
                        class="form-control @error('answer_c') is-invalid @enderror" placeholder="Cの答えを入力" aria-label="回答C"
                        aria-describedby="answer-c">
                </div>
                <div class="input-group flex-nowrap my-2">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="answer-d">D</span>
                    </div>
                    <input name="answer_d" type="text" value="{{ old('answer_d') }}"
                        class="form-control @error('answer_d') is-invalid @enderror" placeholder="Dの答えを入力" aria-label="回答D"
        ...
        <div class="mt-3 mb-5">
            ...
            <div class="form-group">
                ...
                <select name="correct_answer" class="form-control @error('correct_answer') is-invalid @enderror"
            ...
            <div class="form-group">
                ...
                <textarea name="explanation" class="form-control @error('explanation') is-invalid @enderror" id="explanationTextarea"
